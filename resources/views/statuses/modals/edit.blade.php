                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="post" action="{{ route('status.update', $id) }}" autocomplete="off">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group mb-3 input-success">
                                                <input type="number" class="form-control" name="point_min" value="{{ $status->point_min }}"> 
                                            </div>                              
                                        </div>
                                        <div class="col-sm-6 mt-2 mt-sm-0">
                                            <label class="form-label">Max</label>
                                            <div class="input-group mb-3 input-success">
                                                <input type="number" class="form-control" name="point_max" value="{{ $status->point_max }}"> 
                                            </div>                                           
                                        </div>
                                    </div>
